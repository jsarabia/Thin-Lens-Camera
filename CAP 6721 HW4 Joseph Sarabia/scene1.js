...
function Scene(filename)
{
	...
	var nMaterials=0;
	var materials=[];
	var materialStructureFloats = 2*3; // Diffuse reflectance and Mirror reflectance
	...
	{		
		...
		for (var i=0;i<nMaterials;i++){
			...
			materials.push(material.mirrorReflectance[0]);materials.push(material.mirrorReflectance[1]);materials.push(material.mirrorReflectance[2]);
		}
